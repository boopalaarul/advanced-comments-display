...
export const SetSubmitModeContext = createContext(null);
...
export default function SubmitModeProvider({children} : {children: any}) {
    ...
    return (
        <SubmitModeContext.Provider value={submitMode as any}>
            <SetSubmitModeContext.Provider value={setSubmitMode as any}>
                {children}
